...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-900/5 blur-[120px] rounded-full" />
      ...
      >
        <div className="text-center mb-10">
           ...
           <h2 className="text-2xl font-bold text-zinc-50 mb-2">Back to the discourse.</h2>
           <p className="text-zinc-500 text-sm font-medium">Continue your journey with the community.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 space-y-6 shadow-2xl shadow-black/50">
            {error && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                 ...
                 <input 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-lg py-3.5 pl-12 pr-4 text-zinc-200 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500/30 transition-all font-medium text-sm"
        ...
        <p className="text-center mt-8 text-xs text-zinc-500">
          New to Echo? <Link to="/register" className="text-blue-400 font-bold hover:text-blue-300 transition-colors">Join the nexus</Link>
        </p>
      </motion.div>
    </div>
  );
